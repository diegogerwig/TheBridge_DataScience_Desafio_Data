...
buyer_profiles = {
    ...
    #     'nearby_capitals': ['Vitoria-Gasteiz', 'Donostia', 'Santander', 'Logroño', 'Burgos'],
    ...
    'buyer_2': {
        ...
        'nearby_capitals': ['Bilbao', 'Vitoria-Gasteiz', 'Donostia', 'Santander', 'Pamplona'],
    ...
    'buyer_3': {
        ...
        'nearby_capitals': ['Bilbao', 'Donostia', 'Logroño', 'Pamplona', 'Burgos'],
    ...
    'buyer_4': {
        ...
        'nearby_capitals': ['Bilbao', 'Vitoria-Gasteiz', 'Donostia', 'Zaragoza', 'Logroño'],
    ...
    'buyer_5': {
        ...
        'nearby_capitals': ['Bilbao', 'Vitoria-Gasteiz', 'Donostia', 'Santander', 'Burgos'],
    ...
    'buyer_6': {
        ...
        'nearby_capitals': ['Bilbao', 'Donostia', 'Logroño', 'Burgos', 'Pamplona'],
