...
buyer_profiles = {
    'buyer_1': {
        ...
        'initial_balance_range': (3000, 5000),
        'salary': (500, 3000),
        'has_partner': False,
        'partner_works': False,
        'children': 0,
    ...
    'buyer_2': {
        ...
        'initial_balance_range': (1000, 12000),
        'salary': (1900, 2000),
        'has_partner': False,
        'partner_works': False,
        'children': 2,
    ...
    'buyer_3': {
        ...
        'initial_balance_range': (6000, 8000),
        'salary': (3000, 3500),
        'has_partner': True,
        'partner_works': True,
        'children': 0,
    ...
    'buyer_4': {
        ...
        'initial_balance_range': (5000, 6000),
        'salary': (1000, 3000),
        'has_partner': True,
        'partner_works': False,
        'children': 3,
    ...
    'buyer_7': {
        ...
        'initial_balance_range': (10000, 1500),
        'salary': (1200, 1500),
        'has_partner': True,
        'partner_works': False,
        'children': 2,
